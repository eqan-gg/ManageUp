...
function NewTasks({data, setAcceptedState}) {
  ...
  return (
    ...
    <div className="h-full w-[300px] bg-indigo-400 rounded-xl flex-shrink-0">  <div className="flex justify-between p-5 items-center">
       ...
       <button className='bg-orange-600  px-3 py-2 rounded-2xl text-sm' onClick={onClickHandler}>Accept Task</button>
